...
El método "/sales/billPayment/availablesCompanies" sirve para obtener todas las empresas habilitadas para operar. Estas poseen una estructura la cual se detalla a continuacion.
...
Se utiliza un  método POST /sales/billPayment/availablesBill/findByBarCode. En el body del request se debe enviar el dato "billBarCode" (código de barras) como en el siguiente ejemplo.
...
En este caso el código de barras ingresado trae facturas de distintas empresas y se deberá el code (código de empresa)de la siguiente manera.
...
Dicho code, lo obtenemos con el método "/sales/billPayment/availablesCompanies".
...
Para abonar una factura se debería usar un POST con el método /sales/billPayment/. 

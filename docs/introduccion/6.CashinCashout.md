...
##### La consulta de cashin puede realizarse con 2 metodos distintos. Por codigo de barras (el cual viajara en el campo bar_code); y por datos del cliente (el cual viajara en el campo customer_id)

...
Por ultimo, si el response devuelve el estado **pendiente** se deberá enviar la consulta de estado hasta obtener en el response un estado final (rechazada o aprobada).

...
---------|----------|---------
 ...
 product | Producto | En el caso del producto, le enviamos un objeto que dentro contiene el **ID** del producto a utilizar (el cual buscaste antes con el metodo /producto)

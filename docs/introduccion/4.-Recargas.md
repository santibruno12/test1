...
Al igual que  el recibo, para este metodo se requiere el **ID** para utilizarlo. El metodo seria [/sale/{id}](https://santi-bruno.stoplight.io/docs/test1/swagger.yaml/paths/~1sale~1%7Bid%7D/get) 

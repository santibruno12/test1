...
Esto lo haremos a traves del metodo **[/products](https://santi-bruno.stoplight.io/docs/test1/swagger.yaml/paths/~1products/get)**, el cual te devuevle todos los productos disponibles para utilizar. Necesitaremos guardar el ID del producto que vamos a utliziar
```json
[
  {

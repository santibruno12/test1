...
status| String| Estado del cliente
message| String| Mensajes extras
confirmation_id| String |Numero de confirmación de la transacción
...
status| String| Estado del cliente
message| String| Mensajes extras
confirmation_id| String |Numero de confirmación de la transacción en la
empresa subscripta

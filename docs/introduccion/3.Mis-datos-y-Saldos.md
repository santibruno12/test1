...
Para obtener los datos personales deberán utilizar el método **[/me](https://santi-bruno.stoplight.io/docs/test1/swagger.yaml/paths/~1me/get)**. 
...
Para obtener los datos de la cuenta deberán utilizar el método **[/my-account](https://santi-bruno.stoplight.io/docs/test1/swagger.yaml/paths/~1my-account/get)**. 
...
Para obtener los saldos disponibles y los **ID** de cada "Bolsa de Saldo" deberán utilizar el método **[/financial-accounts](https://santi-bruno.stoplight.io/docs/test1/swagger.yaml/paths/~1financial-accounts/get)**. 
...
Para obtener el saldo de una bolsa específica deberán agregar el ID de la bolsa al ejecutar el método **[/financial-account/{id}](https://santi-bruno.stoplight.io/docs/test1/swagger.yaml/paths/~1financial-account~1%7Bid%7D/get)**
